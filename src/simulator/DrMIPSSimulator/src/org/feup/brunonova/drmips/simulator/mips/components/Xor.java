...
public class Xor extends SimpleBinaryOperationComponent {
	 ...
	 */
	public Xor(String id, int latency, Point position, String in1Id, String in2Id, String outId) throws InvalidCPUException {
		super(id, latency, "XOR", "xor", "xor_description", position, new Dimension(30, 30), in1Id, in2Id, outId, 1);
	}
